---
title: "Predicting Canadian Federal Election Results Using Post-Stratification"
...
This analysis aims to forecast the popular vote for the upcoming Canadian federal election (2029) utilizing survey data from CES2021 along with Canadian Census data from 2021.
Our emphasis will be on the Liberal, Conservative, and NDP parties, employing regression models integrated with post-stratification to assess the total vote share.

Research question:
What proportion of the Canadian population is predicted to vote for each major political party based on age and province demographics?

Hypotheses:
1. Younger voters will be more likely to vote for the NDP and Liberal parties.
2. Older voters will be more likely to vote for the Conservative Party.
